    ...
    <>
      ...
      <Container>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="mb-20">
            <Container>
              <h1 className="text-[40px] font-semibold text-black mt-20">
                Send Your Request
              </h1>
              <input
                type="text"
                placeholder="Name"
                className=" font-semibold mt-10 w-[550px] border-2 border-black text-[20px] px-3 py-2 focus:outline-none"
              />
              <input
                type="text"
                placeholder="Email Address"
                className=" font-semibold mt-4 w-[550px] border-2 border-black text-[20px] px-3 py-2 focus:outline-none"
              />
              <input
                type="text"
                placeholder="Phone"
              ...
              ></textarea>
              <br />
              <button className="w-[550px] h-[45px] rounded-md text-white mt-3 bg-black">
                Send Massage
              </button>
            </Container>
          </div>
      ...
      <div>
        ...
        <div className="container mx-auto py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 ml-10 -space-x-10">
